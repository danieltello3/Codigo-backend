# Generated by Django 3.2.4 on 2021-06-16 01:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuarioApellido', models.CharField(db_column='apellido', help_text='Aqui debes ingresar el apellido', max_length=25, verbose_name='Apellido del Usuario')),
                ...
                ('usuarioDni', models.CharField(db_column='dni', help_text='Ingrese un dni valido', max_length=8, verbose_name='Dni del Usuario')),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['-usuarioCorreo', 'usuarioDni'], name='usuarios_correo_d7fddf_idx'),
        ),
